...
/// </summary>
public sealed class DoubaoAskPlugin : UrlLaunchPluginBase
{
    ...
    public override string Description => "打开豆包网页版并自动发送选中文本作为提问";
    ...
    /// </summary>
    public override string BuildUrl(string text)
    {
